...
class FPLLiveGameweek:
    ...
    def get_live_gameweek(self, gameweek: int, force_refresh=False):
...
def main():
    ...
    try:
        output_data['live'] = live_fetcher.get_live_gameweek(gameweek=args.gameweek, force_refresh=args.force_refresh)
